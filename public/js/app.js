document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    tr: {
      ...
      btnPaste: '<i class="fa-regular fa-clipboard"></i> <span>Yapıştır</span>',
      btnPasteSuccess: '<i class="fa-solid fa-check"></i> <span>Yapıştırıldı</span>',
    ...
    en: {
      ...
      btnPaste: '<i class="fa-regular fa-clipboard"></i> <span>Paste</span>',
      btnPasteSuccess: '<i class="fa-solid fa-check"></i> <span>Pasted</span>',
